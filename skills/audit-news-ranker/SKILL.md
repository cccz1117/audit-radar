...
来自微信公众号 RSS 镜像（如 `plink.anyfeeder.com/weixin/...`）的候选，如果是**论文解读、学术会议、HuggingFace 相关研究**：

- 排名适度提前：这类内容经过人工筛选，信息密度高
- 如果主题是 AI 安全、模型治理、金融 AI、数据治理，优先级进一步提高
- 如果是纯产品软文或会议广告，不加分

## arXiv 论文

- 原始 arXiv 论文默认不加分，除非已被其他媒体（机器之心、量子位、HackerNews、Scour 个人 RSS 等）交叉验证
- 如果 arXiv 论文涉及 AI 安全/审计/金融/算法治理，或被顶级会议收录，可正常参与排序
- 如果候选摘要包含 `[论文摘要]` 富化内容，说明该论文已在系统论文库中，可结合原论文 abstract 判断其真实审计价值，避免被标题党误导

## 一手 vs 二手信源

- 一手信源（监管公告、官方 Status Page、公司博客、顶级会议论文）优先
- 二手解读如果质量高、有增量信息，也可靠前
- 营销号、纯转载、无增量解读的后排
