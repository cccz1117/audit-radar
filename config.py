...
MODEL_CLUSTER = os.getenv("MODEL_CLUSTER", "")     # AI 聚类，空则 fallback
...
# AI 聚类开关：开启后由 LLM 直接对去重后条目做事件分组（根治关键词聚类的
# 停用词误并/中英跨语言不聚），LLM 失败自动回退关键词聚类
CLUSTER_USE_AI = _bool_env("CLUSTER_USE_AI", False)
